...
@Component({
  selector: 'app-state-transposition',
  templateUrl: './state-transposition.component.html',
  styleUrls: ['./state-transposition.component.css']
})
export class StateTranspositionComponent implements OnInit {
